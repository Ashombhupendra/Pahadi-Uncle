...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final FastLibraryAccessors laccForFastLibraryAccessors = new FastLibraryAccessors(owner);
    private final FirebaseLibraryAccessors laccForFirebaseLibraryAccessors = new FirebaseLibraryAccessors(owner);
    private final LifecycleLibraryAccessors laccForLifecycleLibraryAccessors = new LifecycleLibraryAccessors(owner);
    private final LightLibraryAccessors laccForLightLibraryAccessors = new LightLibraryAccessors(owner);
    ...
    private final OopsLibraryAccessors laccForOopsLibraryAccessors = new OopsLibraryAccessors(owner);
    ...
    private final SweetLibraryAccessors laccForSweetLibraryAccessors = new SweetLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>isoparser</b> with <b>com.googlecode.mp4parser:isoparser</b> coordinates and
     * with version reference <b>isoparser</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getIsoparser() {
        return create("isoparser");
    }
    ...
    /**
     * Dependency provider for <b>progressbutton</b> with <b>com.github.razir.progressbutton:progressbutton</b> coordinates and
     * with version reference <b>progressButton</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getProgressbutton() {
        return create("progressbutton");
    }
    ...
    /**
     * Dependency provider for <b>silicompressor</b> with <b>com.iceteck.silicompressorr:silicompressor</b> coordinates and
     * with version reference <b>silicompressor</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getSilicompressor() {
        return create("silicompressor");
    }
    ...
    /**
     * Group of libraries at <b>fast</b>
     */
    public FastLibraryAccessors getFast() {
        return laccForFastLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>light</b>
     */
    public LightLibraryAccessors getLight() {
        return laccForLightLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>oops</b>
     */
    public OopsLibraryAccessors getOops() {
        return laccForOopsLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>shortcut</b>
     */
    ...
    /**
     * Group of libraries at <b>sweet</b>
     */
    public SweetLibraryAccessors getSweet() {
        return laccForSweetLibraryAccessors;
    }
    ...
    public static class AndroidxLivedataLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getLifecycle() {
            return create("androidx.livedata.lifecycle");
        }
    ...
    public static class FastLibraryAccessors extends SubDependencyFactory {
        private final FastAndroidLibraryAccessors laccForFastAndroidLibraryAccessors = new FastAndroidLibraryAccessors(owner);

        public FastLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>fast.android</b>
         */
        public FastAndroidLibraryAccessors getAndroid() {
            return laccForFastAndroidLibraryAccessors;
        }

    }

    public static class FastAndroidLibraryAccessors extends SubDependencyFactory {

        public FastAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>networking</b> with <b>com.github.amitshekhariitbhu.Fast-Android-Networking:jackson-android-networking</b> coordinates and
         * with version reference <b>fastAndroidNetworking</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getNetworking() {
            return create("fast.android.networking");
        }
    ...
    public static class LightLibraryAccessors extends SubDependencyFactory {

        public LightLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compressor</b> with <b>com.github.AbedElazizShe:LightCompressor</b> coordinates and
         * with version reference <b>lightCompressor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompressor() {
            return create("light.compressor");
        }
    ...
    public static class NavLibraryAccessors extends SubDependencyFactory {
        private final NavFragmentLibraryAccessors laccForNavFragmentLibraryAccessors = new NavFragmentLibraryAccessors(owner);
        private final NavUiLibraryAccessors laccForNavUiLibraryAccessors = new NavUiLibraryAccessors(owner);

        public NavLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>nav.fragment</b>
         */
        public NavFragmentLibraryAccessors getFragment() {
            return laccForNavFragmentLibraryAccessors;
        }

        /**
         * Group of libraries at <b>nav.ui</b>
         */
        public NavUiLibraryAccessors getUi() {
            return laccForNavUiLibraryAccessors;
        }

    }

    public static class NavFragmentLibraryAccessors extends SubDependencyFactory {

        public NavFragmentLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("nav.fragment.ktx");
        }

    }

    public static class NavUiLibraryAccessors extends SubDependencyFactory {

        public NavUiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
         ...
         */
        public Provider<MinimalExternalModuleDependency> getKtx() {
            return create("nav.ui.ktx");
        }

    }

    public static class OopsLibraryAccessors extends SubDependencyFactory {
        private final OopsNoLibraryAccessors laccForOopsNoLibraryAccessors = new OopsNoLibraryAccessors(owner);

        public OopsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>oops.no</b>
         */
        public OopsNoLibraryAccessors getNo() {
            return laccForOopsNoLibraryAccessors;
        }

    }

    public static class OopsNoLibraryAccessors extends SubDependencyFactory {

        public OopsNoLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>internet</b> with <b>org.imaginativeworld.oopsnointernet:oopsnointernet</b> coordinates and
         * with version reference <b>oopsNoInternet</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getInternet() {
            return create("oops.no.internet");
        }
    ...
    public static class PhotoLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>view</b> with <b>com.github.chrisbanes:PhotoView</b> coordinates and
         * with version reference <b>photoView</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getView() {
            return create("photo.view");
        }
    ...
    public static class ShortcutLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>badger</b> with <b>me.leolin:ShortcutBadger</b> coordinates and
         * with version reference <b>shortcutBadger</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class SweetLibraryAccessors extends SubDependencyFactory {

        public SweetLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>alert</b> with <b>com.github.f0ris.sweetalert:library</b> coordinates and
         * with version reference <b>sweetAlert</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAlert() {
            return create("sweet.alert");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>agpp</b> with value <b>1.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAgpp() { return getVersion("agpp"); }
        ...
        /**
         * Version alias <b>constraintlayout</b> with value <b>2.0.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>dexter</b> with value <b>6.2.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>fastAndroidNetworking</b> with value <b>1.0.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFastAndroidNetworking() { return getVersion("fastAndroidNetworking"); }

        /**
         * Version alias <b>firebaseAnalytics</b> with value <b>19.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseBom</b> with value <b>26.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseCrashlytics</b> with value <b>18.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>isoparser</b> with value <b>1.1.22</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getIsoparser() { return getVersion("isoparser"); }
        ...
        /**
         * Version alias <b>lightCompressor</b> with value <b>0.9.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getLightCompressor() { return getVersion("lightCompressor"); }

        /**
         * Version alias <b>livedata</b> with value <b>2.8.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>nav</b> with value <b>2.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>oopsNoInternet</b> with value <b>2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getOopsNoInternet() { return getVersion("oopsNoInternet"); }
        ...
        /**
         * Version alias <b>paging</b> with value <b>3.0.0-alpha12</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>photoView</b> with value <b>2.1.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>preferenceKtx</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>progressButton</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getProgressButton() { return getVersion("progressButton"); }
        ...
        /**
         * Version alias <b>shortcutBadger</b> with value <b>1.1.22</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getShortcutBadger() { return getVersion("shortcutBadger"); }

        /**
         * Version alias <b>silicompressor</b> with value <b>2.2.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSilicompressor() { return getVersion("silicompressor"); }

        /**
         * Version alias <b>sweetAlert</b> with value <b>1.5.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.version</b> with value <b>1.7.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>agpp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Plugin provider for <b>kotlin.plugins</b> with plugin id <b>org.jetbrains.kotlin.plugin</b> and
         * with version reference <b>agpp</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getPlugins() { return createPlugin("kotlin.plugins"); }
